...
--
-- Host: 127.0.0.1
-- Generation Time: May 16, 2017 at 05:52 AM
...
CREATE TABLE `assignment` (
  ...
  `fdatein` date NOT NULL,
  `fdue_date` date NOT NULL,
...
(24, '2017-05-16', 4, 3, 1, 'Absent'),
(25, '2017-05-16', 4, 3, 4, 'Present'),
(26, '2017-05-16', 4, 3, 19, 'Absent'),
(27, '2017-05-16', 4, 3, 2, 'Absent'),
(28, '2017-05-16', 4, 3, 3, 'Late');
...
(2, 'Manazir', 'Mustafa', 2, 'manazir', 'manazir', 'manazirmustafa@gmail.com', 1687876709, 'uploads/me.jpg', 'Registered'),
...
(88, 'admin', '2017-05-16 09:30:46', '', 15);
...
--
ALTER TABLE `attendance`
  MODIFY `attendance_id` int(30) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;
--
