										...
										<div class="control-group">
                                          ...
                                          <div class="controls">
											...
											$query = mysql_query("select * from teacher_class_student
																  LEFT JOIN teacher ON teacher.teacher_id = teacher_class_student.teacher_id where teacher_class_student.student_id = $session_id group by teacher_class_student.teacher_id order by firstname ASC");
